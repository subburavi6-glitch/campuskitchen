...
const menuItems = [
  ...
  { path: '/vendors', icon: Users, label: 'Vendors', roles: ['ADMIN', 'STORE', 'FNB_MANAGER'] },
  ...
  { path: '/qr-scanner', icon: Camera, label: 'QR Scanner', roles: ['FNB_MANAGER'] },
  { path: '/student-photos', icon: User, label: 'Customers', roles: ['FNB_MANAGER', 'ADMIN'] },
  { path: '/csv-uploads', icon: Upload, label: 'CSV Uploads', roles: ['FNB_MANAGER'] },
